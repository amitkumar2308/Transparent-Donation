...
<img
  src={logo}
  alt="Transparent Donation Logo"
  className="h-12 w-64 mx-auto mt-4 rounded-full border-1 border-blue-500"
  style={{ marginTop: "5rem", marginRight:"5rem", width:"20rem", height:"4rem"}}
/>
