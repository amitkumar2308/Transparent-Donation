...
export default abstract class AccountBase {
     ...
     * @returns Signature
     */
    signTypedData(data: Encoded.ContractBytearray, aci: AciValue, options?: Domain & {
        aeppOrigin?: string;
        aeppRpcClientId?: string;
     ...
     * @returns Signature
     */
    signDelegationToContract(contractAddress: Encoded.ContractAddress, options?: {
        networkId?: string;
        aeppOrigin?: string;
        aeppRpcClientId?: string;
    }): Promise<Encoded.Signature>;
     ...
     * @returns Signature
     */
    signNameDelegationToContract(contractAddress: Encoded.ContractAddress, name: AensName, options?: {
        networkId?: string;
        aeppOrigin?: string;
        aeppRpcClientId?: string;
    }): Promise<Encoded.Signature>;
     ...
     * @returns Signature
     */
    signOracleQueryDelegationToContract(contractAddress: Encoded.ContractAddress, oracleQueryId: Encoded.OracleQueryId, options?: {
        networkId?: string;
        aeppOrigin?: string;
        aeppRpcClientId?: string;
    }): Promise<Encoded.Signature>;
