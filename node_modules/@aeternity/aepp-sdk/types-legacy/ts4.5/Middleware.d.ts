...
export type TransformMiddlewareType<Type> = Type extends (...args: infer Args) => infer Ret ? (...args: TransformMiddlewareType<Args>) => TransformMiddlewareType<Ret> : Type extends [
    infer Item,
    ...infer Rest
] ? [
    TransformMiddlewareType<Item>,
    ...TransformMiddlewareType<Rest>
] : Type extends Array<infer Item> ? Array<TransformMiddlewareType<Item>> : Type extends Promise<infer T> ? Promise<TransformMiddlewareType<T>> : Type extends {
    [P in any]: any;
} ? {
