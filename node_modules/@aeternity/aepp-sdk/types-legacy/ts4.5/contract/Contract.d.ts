...
import { txDryRun, sendTransaction, SendTransactionOptions } from '../chain';
...
type MethodsToContractApi<M extends ContractMethodsBase> = {
    [Name in keyof M]: M[Name] extends (...args: infer Args) => any ? (...args: [
        ...Args,
        ...[
        ] | [
            Name extends 'init' ? Parameters<Contract<M>['$deploy']>[1] : Parameters<Contract<M>['$call']>[2]
        ]
    ]) => ReturnType<Contract<M>['$call']> : never;
};
...
declare class Contract<M extends ContractMethodsBase> {
     ...
     * @returns CallResult
     */
    $call<Fn extends MethodNames<M>>(fn: Fn, params: MethodParameters<M, Fn>, options?: Partial<BuildTxOptions<Tag.ContractCallTx, 'callerId' | 'contractId' | 'callData'>> & Parameters<Contract<M>['$decodeEvents']>[1] & Omit<SendTransactionOptions, 'onAccount' | 'onNode'> & Omit<Parameters<typeof txDryRun>[2], 'onNode'> & {
