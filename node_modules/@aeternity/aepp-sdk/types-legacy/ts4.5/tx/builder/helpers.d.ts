 ...
 * @param name - AENS name
 */
export declare function isNameValid(maybeName: string): maybeName is AensName;
declare const encodingToPointerKey: readonly [
    readonly [
        Encoded.Encoding.AccountAddress,
        "account_pubkey"
    ],
    readonly [
        Encoded.Encoding.OracleAddress,
        "oracle_pubkey"
    ],
    readonly [
        Encoded.Encoding.ContractAddress,
        "contract_pubkey"
    ],
    readonly [
        Encoded.Encoding.Channel,
        "channel"
    ]
];
/**
