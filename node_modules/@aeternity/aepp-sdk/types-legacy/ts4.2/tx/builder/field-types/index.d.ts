...
export type BinaryData = Buffer | Buffer[] | Buffer[][] | Array<[
    Buffer,
    Array<[
        Buffer,
        Buffer[]
...
export { abiVersion, address, array, boolean, coinAmount, ctVersion, deposit, encoded, entry, enumeration, fee, field, gasLimit, gasPrice, map, mptree, name, nameFee, nameId, nonce, pointers, raw, shortUInt, shortUIntConst, string, ttl, uInt, wrapped, };
