 ...
 * @category chain
 */
export declare function _getPollInterval(type: 'block' | 'microblock', // TODO: rename to 'key-block' | 'micro-block'
{ _expectedMineRate, _microBlockCycle, _maxPollInterval }: {
 ...
 */
export declare function getBalance(address: Encoded.AccountAddress | Encoded.ContractAddress | Encoded.OracleAddress, { format, ...options }: {
